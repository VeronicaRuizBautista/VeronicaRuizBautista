...
<p align="center">
<img width="500px" src="https://skillicons.dev/icons?i=js,py,html,css,react,vue,nodejs,express,mongo,git,mysql,vscode,docker,wordpress,aws,fastapi,figma,flask,linux,powershell,pytorch,sqlite,postman,prisma,tailwind,ubuntu,vercel,vscode,vite,ai,kubernetes,sklearn,tensorflow&perline=7" />
</p>
<br>
